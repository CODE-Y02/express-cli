    ...
    nav: [
      ...
      { text: "Reference", link: "/reference/cli-options" },
      {
        ...
        items: [
          ...
          {
            text: "Changelog",
            link: "https://github.com/CODE-Y02/express-cli/blob/main/packages/create-express-forge/CHANGELOG.md",
          },
        ],
      },
      {
        ...
        items: [
          {
            text: "npm",
            link: "https://www.npmjs.com/package/create-express-forge",
          },
          {
            text: "GitHub",
          ...
          {
            text: "Issues",
            link: "https://github.com/CODE-Y02/express-cli/issues",
          },
        ],
      },
    ],
      ...
      "/reference/": [
        {
          ...
          items: [
            { text: "CLI Options", link: "/reference/cli-options" },
            {
              ...
              link: "/reference/generated-structure",
            },
