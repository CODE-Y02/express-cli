...
export { router as todosRouter };\n`);
  ...
  if (opts.auth === 'jwt') {
    ...
    await writeFile(path.join(src, 'modules', 'auth', 'auth.controller.ts'), tm.renderAuthController(2));
